...
import fitness from '../img/fitnessWeb/fitness-1.jpg';
import coffee from '../img/coffeeWeb/coffee-5.jpg';
...
import pacific from '../img/pacificWeb/pacific-1.jpg';
...
import fitnessMobile from '../img/fitnessMobile/fitness-1-mobile.jpg';
import coffeeMobile from '../img/coffeeMobile/coffee-5-mobile.jpeg';
...
import pacificMobile from '../img/pacificMobile/pacific-1-mobile.jpg';
  ...
  return (
    <Animation>
      <Grid spacing={matchesSm ? 2 : matches ? 5 : 10} container>
        ...
        <Grid item>
          <ProjectLink
            image={matches ? fitnessMobile : fitness}
            to='/project/fitness'
            alt='Fitness project'
        ...
        <Grid item>
          <ProjectLink
            image={matches ? pacificMobile : pacific}
            to='/project/pacific'
            alt='Pacific project'
            title='Logo Design'
          />
